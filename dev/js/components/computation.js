      ...
      <div>
        <div className="aboutHeader">
          ...
          <div className="compSecondSection">
             <h5>HeatMap</h5>
             <div className="scanImageDiv" style={{backgroundImage: "url(" + "http://localhost:8000/static/image_heatmap.png"}}></div>
          </div>
                 ...
                 <div className="rangeDrawers">
                     <div className="rangeDiv">
                          ...
                          <div className="second">
                               <input type="range" min="0" value="8" max="10" class="slider" id="myRange" />
                          </div>
                          <div className="third">
                              <p>1</p>
                          </div>
                     ...
                     <div className="rangeDiv insitu">
                          ...
                          <div className="second">
                               <input type="range" min="0" value="7" max="10" class="slider" id="myRange" />
                          </div>
                          <div className="third">
                              <p>1</p>
                          </div>
          ...
          <div className="twoButtonNav">
              ...
              <NavLink to="/computation2" style={{color: 'black', textDecoration: 'none'}}> 
